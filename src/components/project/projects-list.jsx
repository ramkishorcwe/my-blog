...
const projects = [
  {
    title: "Blog Portal",
    description: "A full-stack blog platform with authentication, image uploads, and CRUD operations using Appwrite.",
  ...
  {
    title: "Portfolio Hub",
    description: "Main portfolio app that connects multiple projects with single sign-on support.",
  ...
  {
    title: "E-commerce UI",
    description: "Modern e-commerce frontend with product listing, filters, and cart management.",
